...
// GameStudio capture for an existing TopDownRPG project. The runner passes the .slnx path on
...
public class TopDownLoad : IUITest
{
    ...
    {
        // A passed .slnx should open straight to GameStudioWindow. If the project fails to open,
