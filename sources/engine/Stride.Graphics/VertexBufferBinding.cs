...
public readonly struct VertexBufferBinding : IEquatable<VertexBufferBinding>
{
    ...
    ///   The offset (in number of vertices) from the beginning of the Buffer to the first vertex to use.
    ...
    /// <summary>
    ///   Gets the offset (in number of vertices) from the beginning of the <see cref="Buffer"/> to the first vertex to use.
    /// </summary>
