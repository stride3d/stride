...
namespace Stride.Graphics
{
    ...
    public enum DeviceCreationFlags : int
    {
        ...
        /// </para>
        /// <para>
        /// If you attempt to create a Direct3D device with driver type <strong><see cref="SharpDX.Direct3D.DriverType.Null"/></strong>, <strong><see cref="SharpDX.Direct3D.DriverType.Reference"/></strong>, or <strong><see cref="SharpDX.Direct3D.DriverType.Software"/></strong>, device creation fails at any feature level because none of the associated drivers provide video capability. If you attempt to create a Direct3D device with driver type <strong><see cref="SharpDX.Direct3D.DriverType.Warp"/></strong>, device creation succeeds to allow software fallback for video.
        /// </para> 
