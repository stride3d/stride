    ...
    public partial class QueryPool
    {
        ...
        public unsafe bool TryGetData(long[] dataArray)
        {
            fixed (long* dataPointer = &dataArray[0])
            {
                ...
                var result = GetApi().GetQueryPoolResults(GraphicsDevice.NativeDevice, NativeQueryPool, 0, (uint)QueryCount, (uint)QueryCount * 8, dataPointer, 8, QueryResultFlags.Result64Bit);
