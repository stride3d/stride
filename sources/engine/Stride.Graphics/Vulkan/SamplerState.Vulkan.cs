...
namespace Stride.Graphics
{
    ...
    public partial class SamplerState
    {
        ...
        private static SamplerAddressMode ConvertAddressMode(TextureAddressMode addressMode)
        {
            ...
            {
                TextureAddressMode.Wrap => SamplerAddressMode.Repeat,
                TextureAddressMode.Border => SamplerAddressMode.ClampToBorder,
                TextureAddressMode.Clamp => SamplerAddressMode.ClampToEdge,
                TextureAddressMode.Mirror => SamplerAddressMode.MirroredRepeat,
                TextureAddressMode.MirrorOnce => SamplerAddressMode.MirrorClampToEdge,
