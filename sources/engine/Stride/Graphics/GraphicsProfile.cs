...
///     supports Direct3D 10.0, Direct3D 10.1, and Direct3D 11.0 APIs.
///   </para>
///   <para>
...
public enum GraphicsProfile
{
    ...
    /// </summary>
    [Display("Level 10.0 ~ like Direct3D 10.0 / Vulkan 1.0")]
    Level_10_0 = 0xA000,

    /// <summary>
    ///   Identifies Graphics Devices with capabilities roughly at the level of DirectX 10.1
    ///   (HLSL 4.1, Geometry Shaders), or Vulkan 1.0.
    /// </summary>
    [Display("Level 10.1 ~ like Direct3D 10.1 / Vulkan 1.0")]
    Level_10_1 = 0xA100,

    /// <summary>
    ///   Identifies Graphics Devices with capabilities roughly at the level of DirectX 11
    ///   (HLSL 5.0, Compute Shaders, Domain Shaders, Hull Shaders), or Vulkan 1.1.
    /// </summary>
    [Display("Level 11.0 ~ like Direct3D 11.0 / Vulkan 1.1")]
    Level_11_0 = 0xB000,
    ...
    ///   (HLSL 5.0, Compute Shaders, Domain Shaders, Hull Shaders), or Vulkan 1.1.
    /// </summary>
    [Display("Level 11.1 ~ like Direct3D 11.1 / Vulkan 1.1")]
    Level_11_1 = 0xB100,
    ...
    ///   (HLSL 5.0, Compute Shaders, Domain Shaders, Hull Shaders), or Vulkan 1.1.
    /// </summary>
    [Display("Level 11.2 ~ like Direct3D 11.2 / Vulkan 1.1")]
    Level_11_2 = 0xB200
