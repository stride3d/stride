    ...
    internal static class OpenVR
    {
        ...
        public static bool Submit(int eyeIndex, Texture texture, ref RectangleF viewport)
        {
            unsafe
            {
                var tex = new Texture_t
                {
                    ...
                    handle = (IntPtr)texture.NativeResource.Handle,
                };
        ...
        public static Texture GetMirrorTexture(GraphicsDevice device, int eyeIndex)
        {
            unsafe
            {
                ...
                Valve.VR.OpenVR.Compositor.GetMirrorTextureD3D11(eyeIndex == 0 ? EVREye.Eye_Left : EVREye.Eye_Right, (IntPtr)device.NativeDevice.Handle, ref eyeTexSrv);
