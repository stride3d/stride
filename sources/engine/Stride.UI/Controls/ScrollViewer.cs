...
namespace Stride.UI.Controls
{
    ...
    public class ScrollViewer : ContentControl
    {
        ...
        private readonly bool[] startedSnapping = new bool[2];
        ...
        public ScrollViewer()
        {
            ...
            {
                bar.Measure(Size2F.Zero); // set is measure valid to true
                ...
                if (SnapToAnchors && ContentAsAnchorInfo != null)
                {
                    for (var i = 0; i < 3; ++i)
                    {
                        ...
                        if (closestAnchorIndex == 1)
                        {
                            ...
                            var childRenderSizeWithMargins = childRenderSize + MarginInternal;
                            var childRenderSizeWithPadding = childRenderSizeWithMargins + padding;
        ...
        private void UpdateScrollingBarsSize()
        {
            ...
            foreach (var scrollBar in scrollBars)
                scrollBar.Arrange(Size2F.Zero, false);
            ...
            foreach (var index in ScrollModeToDirectionIndices[ScrollMode])
            {
                var sizeChildren = (ContentAsScrollInfo != null) ?
                    ...
                    VisualContent.RenderSize[index] + VisualContent.MarginInternal[index] + VisualContent.MarginInternal[1 + index];

                var barLength = Math.Min(1f, ViewPort[index] / sizeChildren) * ViewPort[index];

                var barSize = Size2F.Zero;
                for (var dim = 0; dim < 2; dim++)
        ...
        private void UpdateVisualContentArrangeMatrix()
        {
            ...
            var childOffsets = offsets + new Vector2(Padding.Left, Padding.Top) - (Vector2)ViewPort / 2;
        ...
        protected override void UpdateWorldMatrix(ref Matrix parentWorldMatrix, bool parentWorldChanged)
        {
            ...
            if (shouldUpdateScrollBars && VisualContent != null)
            {
                foreach (var index in ScrollModeToDirectionIndices[ScrollMode])
                {
                    ...
                    var barPosition = (Vector2)RenderSize / 2 - (Vector2)scrollBar.RenderSize;
                    ...
                    parentMatrix.TranslationVector += new Vector3(barPosition.X, barPosition.Y, 0);
