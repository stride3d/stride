...
namespace Stride.Audio.Tests.Engine
{
    ...
    public class TestController
    {
        ...
        private void TestDefaultValuesImpl(DefaultGame game)
        {
        ...
        private void TestVolumeSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestVolumeLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
        ...
        private void TestIsLoopedSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestIsLoopedLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
        ...
        private void TestPlaySetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestPlayLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
        ...
        private void TestPauseSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestPauseLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
        ...
        private void TestStopSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestStopLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
        ...
        private void TestPlayStateSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestPlayStateLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 60)
            {
        ...
        private void TestExitLoopSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestExitLoopLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
                mainController.Play();
