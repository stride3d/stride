...
namespace Stride.Audio.Tests.Engine
{
    ...
    public class TestAudioSystem
    {
        ...
        private void TestInitializeAudioEngine(DefaultGame game)
        {
        ...
        private void TestAddRemoveListenerImpl(DefaultGame game)
        {
            var audio = game.Audio;
        ...
        private void TestAddListenerSetup(DefaultGame game)
        {
        ...
        private void TestAddListenerLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
        ...
        private void TestRemoveListenerSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestRemoveListenerLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
        ...
        private void TestAddRemoveEmitterSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            AddRootEntityToEntitySystem(game);
        ...
        private void TestAddRemoveEmitterLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
        ...
        private void TestEffectsAndMusicSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestEffectsAndMusicLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            if (loopCount == 0)
            {
        ...
        private void TestSeveralControllersSetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestSeveralControllersLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
        ...
        private void TestDopplerCoherencySetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestDopplerCoherencyLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
        ...
        private void TestAttenuationCoherencySetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestAttenuationCoherencyLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
        ...
        private void TestLocalizationCoherencySetup(DefaultGame game)
        {
            BuildEntityHierarchy();
            CreateAndAddListenerComponentToEntities();
            CreateAndAddEmitterComponentToEntities();
        ...
        private void TestLocalizationCoherencyLoopImpl(DefaultGame game, int loopCount, int loopCountSum)
        {
            // useless motion on the root entities just to check that is does not disturb to calculations.
            rootSubEntity1.Transform.Position += new Vector3(1, 2, 3);
            listCompEntities[0].Transform.Position += new Vector3(3, 2, -1);
