...
namespace BepuPhysicIntegrationTest.Integration.Components.Constraints.CharacterConstraints;
...
public struct DynamicCharacterMotionConstraint : ITwoBodyConstraintDescription<DynamicCharacterMotionConstraint>
{
	...
	/// </summary>
	public static System.Type TypeProcessorType => typeof(DynamicCharacterMotionTypeProcessor);
	/// <summary>
