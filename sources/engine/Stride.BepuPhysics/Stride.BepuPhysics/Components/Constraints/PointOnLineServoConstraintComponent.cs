...
namespace Stride.BepuPhysics.Components.Constraints
{
    ...
    public sealed class PointOnLineServoConstraintComponent : ConstraintComponent<PointOnLineServo>
    {
        ...
        public Vector3 LocalDirection
        {
            get
            {
                return BepuConstraint.LocalDirection.ToStrideVector();
            }
            set
            {
                BepuConstraint.LocalDirection = value.ToNumericVector();
                ConstraintData?.TryUpdateDescription();
            }
        }
