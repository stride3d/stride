...
namespace Stride.UI.Tests.Regression
{
    ...
    public class BillboardModeTests : UITestGameBase
    {
        ...
        protected override async Task LoadContent()
        {
            ...
            var imageEntity = new Entity { new UIComponent { Page = new UIPage { RootElement = imageElement }, IsFullScreen = false, Resolution = new Size2F(150, 150), Size = new Size2F(1.0f, 1.0f) } };
            ...
            var imageEntity2 = new Entity { new UIComponent { Page = new UIPage { RootElement = imageElement }, IsFullScreen = false, Resolution = new Size2F(200, 200), Size = new Size2F(1.0f, 1.0f) } };
            ...
            var imageEntity3 = new Entity { new UIComponent { Page = new UIPage { RootElement = imageElement }, IsFullScreen = false, Resolution = new Size2F(250, 250), Size = new Size2F(1.0f, 1.0f) } };
