...
namespace Stride.UI.Tests.Regression
{
    ...
    public class ClickTests : UITestGameBase
    {
        ...
        protected override async Task LoadContent()
        {
            ...
            var textblock = new TextBlock { Font = Content.Load<SpriteFont>("LiberationMono12"), SynchronousCharacterGeneration = true };
            ...
            textblock = new TextBlock { Font = Content.Load<SpriteFont>("LiberationMono12"), SynchronousCharacterGeneration = true };
            ApplyTextBlockDefaultStyle(textblock);
