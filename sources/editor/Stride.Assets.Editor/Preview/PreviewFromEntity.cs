...
public abstract class PreviewFromEntity<T> : BuildAssetPreview<T> where T : Asset
{
    ...
    protected class CameraUpdateScript : SyncScript
    {
        ...
        private static readonly BoundingSphere InvalidBoundingSphere = new(Vector3.Zero, MathUtil.ZeroTolerance);
    ...
    protected string BuildName()
    {
        ...
        var typeDisplayName = description != null && !string.IsNullOrEmpty(description.Name) ? description.Name : typeof(T).Name;
    ...
    /// </summary>
    /// <returns>An instance of the <see cref="Preview.PreviewEntity"/> class</returns>
