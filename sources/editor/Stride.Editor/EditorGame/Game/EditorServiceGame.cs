...
{
    public static readonly Color EditorBackgroundColorLdr = new(51, 51, 51, 255);

    public static readonly Color EditorBackgroundColorHdr = new(61, 61, 61, 255);

    private static readonly TimeSpan GameHiddenNextUpdateTime = TimeSpan.FromSeconds(1);

    private readonly TimerTick gameHiddenUpdateTimer = new();
