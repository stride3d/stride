...
{
    private readonly Dictionary<ObjectUrl, OutputObject> database = new();
    ...
    internal readonly AssetCompilerContext CompilerContext = new() { CompilationContext = typeof(AssetCompilationContext) };
    private readonly MicroThreadLock databaseLock = new();
    private readonly GameSettingsAsset databaseGameSettings;
    internal readonly AssetDependenciesCompiler AssetDependenciesCompiler = new(typeof(EditorGameCompilationContext));
    ...
    public GameStudioDatabase(GameStudioBuilderService assetBuilderService, GameSettingsProviderService settingsProvider)
    {
        ...
        ((AssetDependencyManager)assetBuilderService.Session.DependencyManager).AssetChanged += OnAssetChanged;          
    }
