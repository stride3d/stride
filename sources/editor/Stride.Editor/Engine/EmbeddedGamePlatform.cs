...
{
    internal class EmbeddedGamePlatform : GamePlatform, IWindowedPlatform
    {
        public EmbeddedGamePlatform(GameContextWinforms context)
        {

            IsBlockingRun = true;
#if (STRIDE_UI_WINFORMS || STRIDE_UI_WPF)
            MainWindow = GameWindowWinforms(context.Control);
