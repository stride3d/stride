...
{
    private TaskCompletionSource<int> initCompletionSource = new();
    ...
    private async Task<IPreviewView?> ProvideView(IViewModelServiceProvider serviceProvider)
    {
    ...
    private async Task<IAssetPreviewViewModel?> ProvideViewModel(IViewModelServiceProvider serviceProvider)
    {
        var pluginService = serviceProvider.Get<IAssetsPluginService>();
