...
public static class AbstractNodeEntryData
{
    ...
    public static readonly PropertyKey<IEnumerable<AbstractNodeEntry>> Key = new(AbstractNodeMatchingEntries, typeof(AbstractNodeEntryData), new PropertyCombinerMetadata(CombineProperties<AbstractNodeEntry>));
