...
namespace Stride.Core.Assets.Editor.Quantum.NodePresenters
{
    public class AssetNodePresenterFactory : NodePresenterFactory
    {
        ...
        [NotNull]
        public AssetVirtualNodePresenter CreateVirtualNodePresenter([NotNull] INodePresenter parent, string name, Type type, int? order, [NotNull] Func<object> getter, Action<object> setter = null, Func<bool> hasBase = null, Func<bool> isInerited = null, Func<bool> isOverridden = null, Action resetOverride = null)
        {
            if (parent == null) throw new ArgumentNullException(nameof(parent));
            var node = new AssetVirtualNodePresenter(this, parent.PropertyProvider, parent, name, type, order, getter, setter, hasBase, isInerited, isOverridden, resetOverride);
