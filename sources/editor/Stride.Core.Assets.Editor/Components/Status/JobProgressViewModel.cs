...
public class JobProgressViewModel : DispatcherViewModel
{
    ...
    {
        get => message;
        private set => SetValue(ref message, value);
    }
    ...
    {
        get => current;
        set => SetValue(ref current, value, () => Message = string.Format(unformattedMessage, value));
    }

    public int Total
    {
        get => total;
        set => SetValue(ref total, value, () => IsIndeterminate = value < 0);
    }

    public bool IsIndeterminate
    {
        get => isIndeterminate;
        private set => SetValue(ref isIndeterminate, value);
    }
}
