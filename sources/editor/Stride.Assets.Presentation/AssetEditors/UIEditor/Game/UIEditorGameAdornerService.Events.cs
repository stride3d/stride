...
namespace Stride.Assets.Presentation.AssetEditors.UIEditor.Game
{
    partial class UIEditorGameAdornerService
    {
        ...
        private ICollection<UIInputPicking.HitTestResult> GetAdornerVisualsAtPosition(ref Vector3 worldPosition)
        {
            ...
            return UIInputPicking.GetElementsAtPosition(rootElement, ref ray, ref worldViewProj);
        }
