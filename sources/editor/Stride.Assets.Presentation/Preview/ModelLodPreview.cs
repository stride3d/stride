...
namespace Stride.Assets.Presentation.Preview
{
    ...
    /// </summary>
    [AssetPreview(typeof(ModelLodAsset), typeof(ModelLodPreviewView))]
    public class ModelLodPreview : PreviewFromEntity<ModelLodAsset>
    {
        /// <inheritdoc/>
        protected override PreviewEntity CreatePreviewEntity()
        {
            ...
            var entity = new Entity { Name = "Preview Entity of model asset: " + modelLocation };
