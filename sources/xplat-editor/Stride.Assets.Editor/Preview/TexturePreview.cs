...
{
    private readonly Dictionary<TextureCubePreviewMode, Texture> textureCubeViews = new();
    ...
    public TextureDimension Dimension => texture?.ViewDimension ?? default;
    ...
    protected override void LoadContent()
    {
        ...
        {
            for (var i = 0; i < texture.ArraySize; i++)
