...
public class ThumbnailGenerator : IDisposable
{
    ...
    /// </summary>
    public static readonly PropertyKey<ThumbnailGenerator> Key = new("ThumbnailGeneratorKey", typeof(ThumbnailGenerator));
    ...
    private readonly HashSet<GraphicsCompositor> thumbnailGraphicsCompositors = new();
