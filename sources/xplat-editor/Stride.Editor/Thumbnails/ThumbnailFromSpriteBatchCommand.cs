...
{
    public static readonly PropertyKey<IThumbnailFromSpriteBatchCommand> Key = new(nameof(ThumbnailFromSpriteBatchCommand), typeof(ThumbnailFromSpriteBatchCommand));
}
