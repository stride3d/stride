...
public abstract class BuildAssetPreview<T> : AssetPreview<T>
    where T : Asset
{
    ...
    public TAssetType? LoadAsset<TAssetType>(string url, ContentManagerLoaderSettings? settings = null)
    ...
    protected override Task<bool> PrepareContent()
    {
        return BuildAsset();
    }
