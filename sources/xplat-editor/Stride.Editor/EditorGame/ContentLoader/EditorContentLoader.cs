...
public sealed class EditorContentLoader : IEditorContentLoader
{
    ...
    /// </summary>
    private readonly object assetsToReloadLock = new();

    /// <summary>
    /// The assets currently waiting for a reload to be done.
    /// </summary>
    private readonly Queue<ReloadingAsset> assetsToReloadQueue = new();

    /// <summary>
    /// Fast lookup to know what is in <see cref="assetsToReloadQueue"/>.
    /// </summary>
    private readonly Dictionary<AssetItem, ReloadingAsset> assetsToReloadMapping = new();
    ...
    /// <param name="editor">The asset associated with this instance.</param>
    /// <param name="game">The editor game associated with this instance.</param>
    public EditorContentLoader(IDispatcherService gameDispatcher, ILogger logger, AssetEditorViewModel editor, EditorServiceGame game)
    {
        ...
        database = editor.ServiceProvider.Get<GameStudioDatabase>();
    ...
    /// </summary>
    private AssetViewModel Asset => Editor.Asset;
    ...
    /// </summary>
    private ISessionViewModel Session => Asset.Session;
