...
{
    private readonly List<ICopyProcessor> copyProcessors = new();
    private readonly List<IPasteProcessor> pasteProcessors = new();
    private readonly List<IAssetPostPasteProcessor> postProcessors = new();
