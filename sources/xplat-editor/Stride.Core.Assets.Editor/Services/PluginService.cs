...
{
    private readonly Dictionary<Type, Type> assetEditorViewModelTypes = new();
    private readonly Dictionary<Type, Type> assetEditorViewTypes = new();
    ...
    internal void RegisterSession(SessionViewModel session, ILogger logger)
    {
        foreach (var plugin in AssetsPlugin.RegisteredPlugins)
        {
            ...
            {
                // Asset editor view mmodel types
