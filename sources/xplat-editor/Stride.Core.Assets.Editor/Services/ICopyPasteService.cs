...
public interface ICopyPasteService
{
    ...
    string? CopyFromAsset(AssetPropertyGraph? propertyGraph, AssetId? sourceId, object value, bool isObjectReference);
    ...
    /// <returns>A string containing the serialized version of the copied data.</returns>
    string? CopyFromAssets(IReadOnlyList<(AssetPropertyGraph propertyGraph, AssetId? sourceId, object value, bool isObjectReference)> items, Type itemType);
