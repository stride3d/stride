...
public static class NodePresenterExtensions
{
    ...
    public static AssetVirtualNodePresenter CreateCategory(this INodePresenter node, string categoryName, int? order, ExpandRule? expand, params string[]? propertiesToMove)
    {
    ...
    public static bool HasCategory(this INodePresenter node, string categoryName)
    {
    ...
    public static void BypassNode(this INodePresenter node)
    {
        if (node.Parent == null)
