...
internal sealed partial class AssemblyRecompiler
{
    ...
    private IMutableBidirectionalGraph<SourceGroup, CondensedEdge<SyntaxTree, SEdge<SyntaxTree>, SourceGroup>> previousStronglyConnected =
        new BidirectionalGraph<SourceGroup, CondensedEdge<SyntaxTree, SEdge<SyntaxTree>, SourceGroup>>();
    ...
    /// </summary>
    private class LoggerAssemblyProcessorWrapper : TextWriter
    {
