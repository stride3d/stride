...
{
    private readonly Dictionary<IDirtiable, List<IDirtyingOperation>> dirtyingOperationsMap = new();
    private readonly Dictionary<IDirtiable, List<IDirtyingOperation>> frozenOperationsMap = new();
    private readonly HashSet<IDirtyingOperation> allOperations = new();
