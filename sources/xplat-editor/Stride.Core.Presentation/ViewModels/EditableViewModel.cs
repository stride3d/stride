...
{
    private readonly Dictionary<string, object> preEditValues = new();
    private readonly HashSet<string> uncancellableChanges = new();
    private readonly List<string> suspendedCollections = new();
