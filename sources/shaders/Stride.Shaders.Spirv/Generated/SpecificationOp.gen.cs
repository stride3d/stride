...
public static partial class Specification
{
    public enum Op : int
    {
        ...
        OpShaderSDSL = 8000,
        OpCompositionSDSL = 8002,
        OpCompositionEndSDSL = 8003,
        OpMixinInheritSDSL = 8004,
        OpImportShaderSDSL = 8007,
        OpImportFunctionSDSL = 8008,
        OpImportVariableSDSL = 8009,
        OpImportStructSDSL = 8010,
        OpVariableSDSL = 8011,
        OpMemberAccessSDSL = 8012,
        OpTypeFunctionSDSL = 8013,
        OpFunctionMetadataSDSL = 8014,
        OpBaseSDSL = 8015,
        OpThisSDSL = 8016,
        OpStreamsSDSL = 8018,
        OpGenericParameterSDSL = 8019,
        OpGenericReferenceSDSL = 8020,
