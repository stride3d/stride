                ...
                for (var index = 0; index < intrinsicDefinition.Parameters.Length + 1; index++)
                {
                    ...
                    if (isBaseTypeFree)
                    {
                        SymbolType[] baseTypes = parameterType.BaseType switch
                        {
                            ...
                            BaseType.Int32Only => [ScalarType.Int, ScalarType.UInt],
                            BaseType.Int16 => [ScalarType.Int],
                            ...
                            BaseType.Int64Only => [ScalarType.Int64, ScalarType.UInt64],
                            BaseType.Uint => [ScalarType.UInt],
                            BaseType.Uint16 => [ScalarType.UInt],
                            BaseType.U64 => [ScalarType.UInt64],
                            BaseType.Float => [ScalarType.Float],
                            BaseType.Float16 => [ScalarType.Half],
                            ...
                            BaseType.Numeric16Only => [ScalarType.Half],
                            BaseType.Numeric32Only => [ScalarType.Float, ScalarType.Int, ScalarType.UInt],
