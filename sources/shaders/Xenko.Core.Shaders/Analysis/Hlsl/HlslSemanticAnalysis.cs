    ...
    public class HlslSemanticAnalysis : SemanticAnalysis
    {
        ...
        class Function
        {
            ...
            public static Function[] Functions = new[]
	        {
		        ...
		        Template1("InterlockedAdd", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0)),
		        Template1("InterlockedAnd", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0), Param("original_value", 0, outParam: true)),
		        Template1("InterlockedAnd", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0)),
		        Template1("InterlockedCompareExchange", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("compare_value", 0), Param("value", 0), Param("original_value", 0, outParam: true)),
		        Template1("InterlockedCompareStore", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("compare_value", 0), Param("value", 0)),
		        Template1("InterlockedExchange", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0), Param("original_value", 0, outParam: true)),
		        Template1("InterlockedMax", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0), Param("original_value", 0, outParam: true)),
		        Template1("InterlockedMax", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0)),
		        Template1("InterlockedMin", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0), Param("original_value", 0, outParam: true)),
		        Template1("InterlockedMin", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0)),
		        Template1("InterlockedOr", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0), Param("original_value", 0, outParam: true)),
		        Template1("InterlockedOr", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0)),
		        Template1("InterlockedXor", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0), Param("original_value", 0, outParam: true)),
		        Template1("InterlockedXor", AllTargets, new[] {ScalarType.Int, ScalarType.UInt }, Param((f, p) => TypeBase.Void), Param("dest", 0), Param("value", 0)),
