...
namespace Stride.Shaders
{
    ...
    public sealed class ShaderMixinSource : ShaderSource, IEquatable<ShaderMixinSource>
    {
        ...
        public ShaderMixinSource()
        {
            ...
            Compositions = new Stride.Core.Collections.SortedList<string, ShaderSource>();
        ...
        [DataMember(20)]
        public Stride.Core.Collections.SortedList<string, ShaderSource> Compositions { get; set; }
        ...
        private static Stride.Core.Collections.SortedList<TKey, TValue> ToSortedList<TKey, TValue>(IEnumerable<KeyValuePair<TKey, TValue>> list)
        {
            var values = new Stride.Core.Collections.SortedList<TKey, TValue>();
