...
public abstract class Asset
{
    ...
    /// <exception cref="InvalidOperationException">Cannot change an Asset Object Id once it is locked</exception>
    [DataMember(-10000)]
    [NonOverridable]
    ...
    {
        return CreateDerivedAsset(baseLocation, out _);
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(baseLocation);
