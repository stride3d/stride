...
public abstract class CollectionWithIdsSerializerBase : DictionarySerializer
{
    ...
    /// </summary>
    public static readonly PropertyKey<bool> NonIdentifiableCollectionItemsKey = new("NonIdentifiableCollectionItems", typeof(CollectionWithIdsSerializer));
    /// <summary>
    ...
    /// </summary>
    protected static readonly PropertyKey<InstanceInfo> InstanceInfoKey = new("InstanceInfo", typeof(CollectionWithIdsSerializer));
    /// <summary>
    /// A key that identifies deleted items during deserialization.
    /// </summary>
    protected static readonly PropertyKey<ICollection<ItemId>> DeletedItemsKey = new("DeletedItems", typeof(CollectionWithIdsSerializer));
    ...
    protected override void CreateOrTransformObject(ref ObjectContext objectContext)
    {
        ...
        if (objectContext.SerializerContext.IsSerializing && objectContext.Instance != null)
        {
            ...
            if (CollectionItemIdHelper.TryGetCollectionItemIds(objectContext.Instance, out var identifier))
            {
    ...
    protected override void ReadDictionaryItems(ref ObjectContext objectContext)
    {
        ...
        while (!reader.Accept<MappingEnd>())
        {
            ...
            try
            {
                ...
                if (!Equals(keyValue.Value, YamlDeletedKey) || keyValue.Key is not ItemId id)
                {
