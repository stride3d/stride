...
public class ConstraintProvider
{
    ...
    /// </summary>
    private readonly Dictionary<string, PackageVersionRange> constraints = new(StringComparer.OrdinalIgnoreCase);
    ...
    {
        if (constraints.TryGetValue(packageId, out var versionRange))
        {
            return versionRange;
        }
        return null;
