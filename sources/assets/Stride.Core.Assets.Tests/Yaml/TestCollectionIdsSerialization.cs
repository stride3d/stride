...
public class TestCollectionIdsSerialization
{
    public class ContainerCollection
    {
        ...
        public List<ContainerCollection> Objects { get; set; } = [];
    }
    ...
    public class ContainerDictionary
    {
        ...
        public string? Name { get; set; }
        public Dictionary<Guid, string> Strings { get; set; } = [];
        public Dictionary<string, ContainerCollection> Objects { get; set; } = [];
    }
    ...
    public class ContainerNonIdentifiableCollection
    {
        ...
        public List<ContainerCollection> NonIdentifiableObjects { get; set; } = [];
    }
    ...
    private const string YamlCollection =
        """
        !Stride.Core.Assets.Tests.Yaml.TestCollectionIdsSerialization+ContainerCollection,Stride.Core.Assets.Tests
        Name: Root
        Strings:
    ...
    private const string YamlCollectionNotIdentifiable =
        """
        !Stride.Core.Assets.Tests.Yaml.TestCollectionIdsSerialization+ContainerNonIdentifiableCollection,Stride.Core.Assets.Tests
        Name: Root
        Objects:
    ...
    private const string YamlDictionary =
        """
        !Stride.Core.Assets.Tests.Yaml.TestCollectionIdsSerialization+ContainerDictionary,Stride.Core.Assets.Tests
        Name: Root
        Strings:
    ...
    private const string YamlDictionaryNonIdentifiable =
        """
        !Stride.Core.Assets.Tests.Yaml.TestCollectionIdsSerialization+ContainerNonIdentifiableDictionary,Stride.Core.Assets.Tests
        Name: Root
        Objects:
            02000000020000000200000002000000~AAA:
                Name: aaa
    ...
    private const string YamlCollectionWithDeleted =
        """
        !Stride.Core.Assets.Tests.Yaml.TestCollectionIdsSerialization+ContainerCollection,Stride.Core.Assets.Tests
        Name: Root
        Strings:
    ...
    private const string YamlDictionaryWithDeleted =
        """
        !Stride.Core.Assets.Tests.Yaml.TestCollectionIdsSerialization+ContainerDictionary,Stride.Core.Assets.Tests
        Name: Root
        Strings:
    ...
    public void TestCollectionNonIdentifiableItemsDeserialization()
    {
        ...
        Assert.False(CollectionItemIdHelper.TryGetCollectionItemIds(obj.NonIdentifiableObjects, out _));
    ...
    public void TestIdsGeneration()
    {
        ...
        Assert.False(CollectionItemIdHelper.TryGetCollectionItemIds(obj1.Strings, out _));
        Assert.False(CollectionItemIdHelper.TryGetCollectionItemIds(obj1.Strings, out _));
        Assert.False(CollectionItemIdHelper.TryGetCollectionItemIds(obj1.Objects, out _));
        Assert.False(CollectionItemIdHelper.TryGetCollectionItemIds(obj1.Objects, out _));
        AssetCollectionItemIdHelper.GenerateMissingItemIds(obj1);
        Assert.True(CollectionItemIdHelper.TryGetCollectionItemIds(obj1.Strings, out var ids));
        ...
        hashSet.Clear();
        Assert.False(CollectionItemIdHelper.TryGetCollectionItemIds(obj2.Strings, out _));
        Assert.False(CollectionItemIdHelper.TryGetCollectionItemIds(obj2.Strings, out _));
        Assert.False(CollectionItemIdHelper.TryGetCollectionItemIds(obj2.Objects, out _));
        Assert.False(CollectionItemIdHelper.TryGetCollectionItemIds(obj2.Objects, out _));
