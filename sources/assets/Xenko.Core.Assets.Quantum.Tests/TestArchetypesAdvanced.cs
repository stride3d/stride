...
namespace Xenko.Core.Assets.Quantum.Tests
{
    public class TestArchetypesAdvanced
    {
        ...
        public void TestSimpleDictionaryAddWithCollision()
        {
            ...
            Assert.Equal("String4", basePropertyNode.Retrieve(new Index("Key3")));
        ...
        public void TestSimpleCollectionUpdateDeleted()
        {
            ...
            Assert.Equal("String1", basePropertyNode.Retrieve(new Index(0)));
            Assert.Equal("String2", basePropertyNode.Retrieve(new Index(1)));
            Assert.Equal("String3.5", basePropertyNode.Retrieve(new Index(2)));
        ...
        public void TestSimpleDictionaryUpdateDeleted()
        {
            ...
            Assert.Equal("String1", basePropertyNode.Retrieve(new Index("Key1")));
            Assert.Equal("String2", basePropertyNode.Retrieve(new Index("Key2")));
            Assert.Equal("String3.5", basePropertyNode.Retrieve(new Index("Key3")));
            Assert.Equal("String4", basePropertyNode.Retrieve(new Index("Key4")));
            Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index("Key1")));
            Assert.Equal("String2", derivedPropertyNode.Retrieve(new Index("Key2")));
            Assert.Equal("String4", derivedPropertyNode.Retrieve(new Index("Key4")));
        ...
        public void TestRemoveBaseAddDerivedWithSubDerived()
        {
            ...
            Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index(0)));
            Assert.Equal("String3", derivedPropertyNode.Retrieve(new Index(1)));
            Assert.Equal("String1", subDerivedPropertyNode.Retrieve(new Index(0)));
            Assert.Equal("String3", subDerivedPropertyNode.Retrieve(new Index(1)));
            Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
            Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
            Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
            Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(2)));
            ...
            Assert.Equal(OverrideType.Base, subDerivedPropertyNode.Target.GetItemOverride(new Index(0)));
            Assert.Equal(OverrideType.Base, subDerivedPropertyNode.Target.GetItemOverride(new Index(1)));
            Assert.Equal(3, baseIds.KeyCount);
            Assert.Equal(0, baseIds.DeletedCount);
        ...
        public void TestAddBaseRemoveDerivedAndAddInBaseWithSubDerived()
        {
            ...
            Assert.Equal("String4", derivedPropertyNode.Retrieve(new Index(2)));
            Assert.Equal("String1", subDerivedPropertyNode.Retrieve(new Index(0)));
            Assert.Equal("String2", subDerivedPropertyNode.Retrieve(new Index(1)));
            Assert.Equal("String4", subDerivedPropertyNode.Retrieve(new Index(2)));
            Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
            Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
            Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
            Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(2)));
            ...
            Assert.Equal(OverrideType.Base, subDerivedPropertyNode.Target.GetItemOverride(new Index(0)));
            Assert.Equal(OverrideType.Base, subDerivedPropertyNode.Target.GetItemOverride(new Index(1)));
            Assert.Equal(OverrideType.Base, subDerivedPropertyNode.Target.GetItemOverride(new Index(2)));
            Assert.Equal(4, baseIds.KeyCount);
            Assert.Equal(0, baseIds.DeletedCount);
            Assert.Equal(3, derivedIds.KeyCount);
            Assert.Equal(1, derivedIds.DeletedCount);
        ...
        private static void AssertCollection(IGraphNode node, params string[] items)
        {
            ...
            {
                var item = items[i];
                Assert.Equal(item, node.Retrieve(new Index(i)));
            }
        }
    }
}
