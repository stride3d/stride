    ...
    public class TestArchetypesBasic
    {
        ...
        public static TestArchetypesRun PrepareSimpleCollectionUpdate()
        {
            ...
            test.InitialCheck = () =>
            {
                ...
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
            ...
            test.FirstChangeCheck = () =>
            {
                ...
                Assert.Equal(2, context.DerivedAsset.MyStrings.Count);
                Assert.Equal("String1", basePropertyNode.Retrieve(new Index(0)));
                Assert.Equal("MyBaseString", basePropertyNode.Retrieve(new Index(1)));
                Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index(0)));
                Assert.Equal("MyBaseString", derivedPropertyNode.Retrieve(new Index(1)));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal("String1", basePropertyNode.Retrieve(new Index(0)));
                Assert.Equal("MyBaseString", basePropertyNode.Retrieve(new Index(1)));
                Assert.Equal("MyDerivedString", derivedPropertyNode.Retrieve(new Index(0)));
                Assert.Equal("MyBaseString", derivedPropertyNode.Retrieve(new Index(1)));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.New, derivedPropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(2, baseIds.KeyCount);
                Assert.Equal(0, baseIds.DeletedCount);
        ...
        public static TestArchetypesRun PrepareSimpleCollectionAdd()
        {
            ...
            test.FirstChangeCheck = () =>
            {
                ...
                Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index(0)));
                Assert.Equal("String2", derivedPropertyNode.Retrieve(new Index(1)));
                Assert.Equal("String3", derivedPropertyNode.Retrieve(new Index(2)));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.New, derivedPropertyNode.Target.GetItemOverride(new Index(2)));
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.Equal(2, baseIds.KeyCount);
                Assert.Equal(0, baseIds.DeletedCount);
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal("String3", derivedPropertyNode.Retrieve(new Index(3)));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                ...
                Assert.Equal(OverrideType.New, derivedPropertyNode.Target.GetItemOverride(new Index(3)));
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
        ...
        public static TestArchetypesRun PrepareSimpleCollectionRemove()
        {
            ...
            test.InitialCheck = () =>
            {
                ...
                Assert.Equal("String1", basePropertyNode.Retrieve(new Index(0)));
                Assert.Equal("String2", basePropertyNode.Retrieve(new Index(1)));
                Assert.Equal("String3", basePropertyNode.Retrieve(new Index(2)));
                Assert.Equal("String4", basePropertyNode.Retrieve(new Index(3)));
                Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index(0)));
                Assert.Equal("String2", derivedPropertyNode.Retrieve(new Index(1)));
                Assert.Equal("String3", derivedPropertyNode.Retrieve(new Index(2)));
                Assert.Equal("String4", derivedPropertyNode.Retrieve(new Index(3)));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(2)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(3)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(2)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(3)));
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
        ...
        public static TestArchetypesRun PrepareSimpleDictionaryUpdate()
        {
            ...
            test.InitialCheck = () =>
            {
                ...
                Assert.Equal("String1", basePropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("String2", basePropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("String2", derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(2, baseIds.KeyCount);
            ...
            test.FirstChangeCheck = () =>
            {
                ...
                Assert.Equal(2, context.DerivedAsset.MyDictionary.Count);
                Assert.Equal("String1", basePropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("MyBaseString", basePropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("MyBaseString", derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal("String1", basePropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("MyBaseString", basePropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("MyDerivedString", derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("MyBaseString", derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.New, derivedPropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
        ...
        public static TestArchetypesRun PrepareSimpleDictionaryAdd()
        {
            ...
            test.FirstChangeCheck = () =>
            {
                ...
                Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("String2", derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String3", derivedPropertyNode.Retrieve(new Index("Key3")));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.New, derivedPropertyNode.Target.GetItemOverride(new Index("Key3")));
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(2, baseIds.KeyCount);
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal("String1", basePropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("String2", basePropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String4", basePropertyNode.Retrieve(new Index("Key4")));
                Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("String2", derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String3", derivedPropertyNode.Retrieve(new Index("Key3")));
                Assert.Equal("String4", derivedPropertyNode.Retrieve(new Index("Key4")));
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key4")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.New, derivedPropertyNode.Target.GetItemOverride(new Index("Key3")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key4")));
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(3, baseIds.KeyCount);
        ...
        public static TestArchetypesRun PrepareSimpleDictionaryRemove()
        {
            ...
            test.InitialCheck = () =>
            {
                ...
                Assert.Equal("String1", basePropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("String2", basePropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String3", basePropertyNode.Retrieve(new Index("Key3")));
                Assert.Equal("String4", basePropertyNode.Retrieve(new Index("Key4")));
                Assert.Equal("String1", derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal("String2", derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String3", derivedPropertyNode.Retrieve(new Index("Key3")));
                ...
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key3")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key4")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key3")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key4")));
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
        ...
        public static TestArchetypesRun PrepareObjectCollectionUpdate()
        {
            ...
            test.InitialCheck = () =>
            {
                ...
                Assert.Equal(objB0, basePropertyNode.Retrieve(new Index(0)));
                Assert.Equal(objB1, basePropertyNode.Retrieve(new Index(1)));
                Assert.Equal(objD0, derivedPropertyNode.Retrieve(new Index(0)));
                Assert.Equal(objD1, derivedPropertyNode.Retrieve(new Index(1)));
                Assert.Equal("String1", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String1", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(1)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(1)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(2, baseIds.KeyCount);
            ...
            test.FirstChangeCheck = () =>
            {
                ...
                Assert.Equal(2, context.DerivedAsset.MyObjects.Count);
                Assert.Equal(objB0, basePropertyNode.Retrieve(new Index(0)));
                Assert.Equal(newObjB, basePropertyNode.Retrieve(new Index(1)));
                Assert.Equal(objD0, derivedPropertyNode.Retrieve(new Index(0)));
                Assert.Equal(objD1, derivedPropertyNode.Retrieve(new Index(1)));
                Assert.Equal("String1", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("MyBaseString", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String1", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("MyBaseString", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal(objB0, basePropertyNode.Retrieve(new Index(0)));
                Assert.Equal(newObjB, basePropertyNode.Retrieve(new Index(1)));
                Assert.Equal(newObjD, derivedPropertyNode.Retrieve(new Index(0)));
                Assert.Equal(objD1, derivedPropertyNode.Retrieve(new Index(1)));
                Assert.Equal("String1", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("MyBaseString", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("MyDerivedString", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("MyBaseString", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
        ...
        public static TestArchetypesRun PrepareObjectCollectionAdd()
        {
            ...
            test.FirstChangeCheck = () =>
            {
                ...
                Assert.Equal(objD0, derivedPropertyNode.Retrieve(new Index(0)));
                Assert.Equal(objD1, derivedPropertyNode.Retrieve(new Index(1)));
                Assert.Equal(newObjD, derivedPropertyNode.Retrieve(new Index(2)));
                Assert.Equal("String1", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String1", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String3", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(2))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                ...
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(1)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(2)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(2, baseIds.KeyCount);
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal(objB0, basePropertyNode.Retrieve(new Index(0)));
                Assert.Equal(objB1, basePropertyNode.Retrieve(new Index(1)));
                Assert.Equal(newObjB, basePropertyNode.Retrieve(new Index(2)));
                Assert.Equal(objD0, derivedPropertyNode.Retrieve(new Index(0)));
                Assert.Equal(objD1, derivedPropertyNode.Retrieve(new Index(1)));
                Assert.NotEqual(newObjB, derivedPropertyNode.Retrieve(new Index(2)));
                Assert.Equal(newObjD, derivedPropertyNode.Retrieve(new Index(3)));
                Assert.Equal("String1", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String4", ((Types.SomeObject)basePropertyNode.Retrieve(new Index(2))).Value);
                Assert.Equal("String1", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String4", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(2))).Value);
                Assert.Equal("String3", ((Types.SomeObject)derivedPropertyNode.Retrieve(new Index(3))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(1)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(2)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(2)));
                ...
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(1)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(2)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(3)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(3, baseIds.KeyCount);
        ...
        public static TestArchetypesRun PrepareAbstractCollectionUpdate()
        {
            ...
            test.InitialCheck = () =>
            {
                ...
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String1", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
            ...
            test.FirstChangeCheck = () =>
            {
                ...
                Assert.Equal(newObjB, basePropertyNode.Retrieve(new Index(1)));
                Assert.Equal(objD0, derivedPropertyNode.Retrieve(new Index(0)));
                Assert.NotEqual(objD1, derivedPropertyNode.Retrieve(new Index(1)));
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("MyBaseString", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String1", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("MyBaseString", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.SomeObject.Value)]).GetContentOverride());
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("MyBaseString", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("MyDerivedString", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("MyBaseString", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
        ...
        public static TestArchetypesRun PrepareAbstractCollectionAdd()
        {
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String4", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index(2))).Value);
                Assert.Equal("String1", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(0))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(1))).Value);
                Assert.Equal("String4", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(2))).Value);
                Assert.Equal("String3", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index(3))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(1)].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index(2)].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(0)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(1)));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index(2)));
                Assert.Equal(OverrideType.New, derivedPropertyNode.Target.GetItemOverride(new Index(3)));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(0)].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(1)].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(2)].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index(3)].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(3, baseIds.KeyCount);
        ...
        public static TestArchetypesRun PrepareAbstractDictionaryUpdate()
        {
            ...
            test.InitialCheck = () =>
            {
                Assert.Equal(2, context.BaseAsset.MyDictionary.Count);
                Assert.Equal(2, context.DerivedAsset.MyDictionary.Count);
                Assert.Equal(objB0, basePropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal(objB1, basePropertyNode.Retrieve(new Index("Key2")));
                // NOTE: we're using this code to test undo/redo and in this case, we have different objects in the derived object after undoing due to the fact that the type of the instance has changed
                ...
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal("String1", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index("Key1")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index("Key2")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index("Key1")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index("Key2")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(2, baseIds.KeyCount);
            ...
            test.FirstChangeCheck = () =>
            {
                ...
                Assert.Equal(2, context.DerivedAsset.MyDictionary.Count);
                Assert.Equal(objB0, basePropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal(newObjB, basePropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal(objD0, derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.NotEqual(objD1, derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("MyBaseString", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal("String1", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("MyBaseString", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index("Key1")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal(objB0, basePropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal(newObjB, basePropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal(newObjD, derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.NotEqual(objD1, derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("MyBaseString", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal("MyDerivedString", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("MyBaseString", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
        ...
        public static TestArchetypesRun PrepareAbstractDictionaryAdd()
        {
            ...
            test.InitialCheck = () =>
            {
                ...
                Assert.Equal(objB1, basePropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal(objD0, derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal(objD1, derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal("String1", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key2"))).Value);
            ...
            test.FirstChangeCheck = () =>
            {
                ...
                Assert.Equal(objD0, derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal(objD1, derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal(newObjD, derivedPropertyNode.Retrieve(new Index("Key3")));
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal("String1", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal("String3", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key3"))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index("Key1")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                ...
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index("Key1")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index("Key2")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index("Key3")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(2, baseIds.KeyCount);
            ...
            test.SecondChangeCheck = () =>
            {
                ...
                Assert.Equal(objB0, basePropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal(objB1, basePropertyNode.Retrieve(new Index("Key2")));
                Assert.Equal(newObjB, basePropertyNode.Retrieve(new Index("Key4")));
                Assert.Equal(objD0, derivedPropertyNode.Retrieve(new Index("Key1")));
                Assert.Equal(objD1, derivedPropertyNode.Retrieve(new Index("Key2")));
                Assert.NotEqual(newObjB, derivedPropertyNode.Retrieve(new Index("Key4")));
                Assert.Equal(newObjD, derivedPropertyNode.Retrieve(new Index("Key3")));
                Assert.Equal("String1", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal("String4", ((Types.IMyInterface)basePropertyNode.Retrieve(new Index("Key4"))).Value);
                Assert.Equal("String1", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key1"))).Value);
                Assert.Equal("String2", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key2"))).Value);
                Assert.Equal("String4", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key4"))).Value);
                Assert.Equal("String3", ((Types.IMyInterface)derivedPropertyNode.Retrieve(new Index("Key3"))).Value);
                Assert.Equal(OverrideType.Base, basePropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, basePropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index("Key1")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index("Key2")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)basePropertyNode.Target.ItemReferences[new Index("Key4")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.GetContentOverride());
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key1")));
                Assert.Equal(OverrideType.Base, derivedPropertyNode.Target.GetItemOverride(new Index("Key2")));
                Assert.Equal(OverrideType.New, derivedPropertyNode.Target.GetItemOverride(new Index("Key3")));
                ...
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index("Key2")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index("Key3")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(OverrideType.Base, ((AssetMemberNode)derivedPropertyNode.Target.ItemReferences[new Index("Key4")].TargetNode[nameof(Types.IMyInterface.Value)]).GetContentOverride());
                Assert.Equal(1, derivedPropertyNode.Target.GetOverriddenItemIndices().Count());
                Assert.Equal(0, derivedPropertyNode.Target.GetOverriddenKeyIndices().Count());
                Assert.NotSame(baseIds, derivedIds);
                Assert.Equal(3, baseIds.KeyCount);
