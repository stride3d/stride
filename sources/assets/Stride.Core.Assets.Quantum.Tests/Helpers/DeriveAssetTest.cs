...
public class DeriveAssetTest<TAsset, TAssetPropertyGraph>
    where TAsset : Asset
    where TAssetPropertyGraph : AssetPropertyGraph
{
    ...
    public static DeriveAssetTest<TAsset, TAssetPropertyGraph> DeriveAsset(TAsset baseAsset, bool deriveTwice = true)
    {
        ...
        return new DeriveAssetTest<TAsset, TAssetPropertyGraph>(baseContainer, derivedContainer, subDerivedContainer);
    }
