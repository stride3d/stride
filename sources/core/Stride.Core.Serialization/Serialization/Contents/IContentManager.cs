...
public interface IContentManager
{
    ...
    /// <param name="loadedManuallyOnly">If <c>true</c>, this method will return true only if an asset with the given URL has been manually loaded via <see cref="Load{T}"/>, and not if the asset has been only loaded indirectly from another asset.</param>
