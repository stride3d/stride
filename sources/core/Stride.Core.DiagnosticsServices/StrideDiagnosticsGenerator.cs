...
[Generator]
public class StrideDiagnosticsGenerator : ISourceGenerator
{
    ...
    {
        StrideDiagnosticsSyntaxReceiver syntaxReceiver = (StrideDiagnosticsSyntaxReceiver)context.SyntaxReceiver;
