...
{
    private DataSerializer<T1> item1Serializer = null!;
...
{
    private DataSerializer<T1> item1Serializer = null!;
    private DataSerializer<T2> item2Serializer = null!;
...
public class TupleSerializer<T1, T2, T3> : DataSerializer<Tuple<T1, T2, T3>>
{
    private DataSerializer<T1> item1Serializer = null!;
    private DataSerializer<T2> item2Serializer = null!;
    private DataSerializer<T3> item3Serializer = null!;
...
public class TupleSerializer<T1, T2, T3, T4> : DataSerializer<Tuple<T1, T2, T3, T4>>
{
    ...
    private DataSerializer<T2> item2Serializer = null!;
    private DataSerializer<T3> item3Serializer = null!;
    private DataSerializer<T4> item4Serializer = null!;
