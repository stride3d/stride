...
namespace Stride.Core.CompilerServices
{
    public static class Diagnostics
    {
        ...
        public static DiagnosticDescriptor CompilerServicesExceptionDuringDataContractGeneration = new DiagnosticDescriptor(
        ...
        public const string DataContractDiagnosticIdFormat = "STR2{0:000}";
        public const string DataContractDiagnosticCategory = "Stride.Serialization";

        public static DiagnosticDescriptor DataContractClassHasNoAccessibleParameterlessCtor = new DiagnosticDescriptor(
        ...
        public static DiagnosticDescriptor DataContractMemberHasBothIncludeAndIgnoreAttr = new DiagnosticDescriptor(
        ...
        public static DiagnosticDescriptor DataContractMemberHasNonSerializableType = new DiagnosticDescriptor(
        ...
        public static DiagnosticDescriptor DataSerializerNoTypeInformation = new DiagnosticDescriptor(
        ...
        public static DiagnosticDescriptor DataSerializerGlobalNoTypeInformation = new DiagnosticDescriptor(
        ...
        public static DiagnosticDescriptor DataSerializerDoesNotExtendDataSerializerBaseClass = new DiagnosticDescriptor(
        ...
        public static DiagnosticDescriptor DataSerializerGlobalDuplicateDeclarations = new DiagnosticDescriptor(
