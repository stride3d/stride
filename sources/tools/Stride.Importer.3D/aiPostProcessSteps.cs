...
public enum aiPostProcessSteps : uint
{
    ...
    ///  converts them to proper lines or points./// A face is 'degenerate' if one or more of its points are identical.
    ...
    ///   </li>
    /// </ul>/// This step also removes very small triangles with a surface area smaller
    ...
    ///  intended to get rid of some common exporter errors./// This is especially useful for normals. If they are invalid, and
