...
public class DynamicBuildStep : BuildStep
{
    ...
    /// </summary>
    private readonly AutoResetEvent newWorkAvailable = new(false);
    ...
    private async Task CompleteOneBuildStep(IExecuteContext executeContext, List<BuildStep> buildStepsToWait)
    {
        ...
        {
            waitHandles = waitHandles.Concat([newWorkAvailable]);
        }
        ...
        await ListBuildStep.WaitCommands([completeBuildStep]);
