...
public static class OperatorTokenExtensions
{
    ...
    public static DirectiveToken ApplyOperation(OperatorToken op, NumberLiteral l, NumberLiteral r)
    {
        return op switch
        {
    ...
    public static DirectiveToken ApplyOperation(OperatorToken op, BoolLiteral l, BoolLiteral r)
    {
        return op switch
        {
    ...
    public static DirectiveToken ApplyOperation(OperatorToken op, StringLiteral l, StringLiteral r)
    {
        return op switch
        {
            OperatorToken.Equals => new BoolLiteral { Value = l.Value == r.Value },
