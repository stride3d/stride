...
internal class IntrinsicImplementations : IntrinsicsDeclarations
{
    ...
    // Compute interlocked
    public override SpirvValue CompileInterlockedAdd(SpirvContext context, SpirvBuilder builder, FunctionType functionType, SpirvValue result, SpirvValue value) => CompileInterlockedCall(context, builder, functionType, InterlockedOp.Add, result, value);
    ...
    public override SpirvValue CompileInterlockedMin(SpirvContext context, SpirvBuilder builder, FunctionType functionType, SpirvValue result, SpirvValue value) => CompileInterlockedCall(context, builder, functionType, InterlockedOp.Min, result, value);
    ...
    public override SpirvValue CompileInterlockedMax(SpirvContext context, SpirvBuilder builder, FunctionType functionType, SpirvValue result, SpirvValue value) => CompileInterlockedCall(context, builder, functionType, InterlockedOp.Max, result, value);
    ...
    public override SpirvValue CompileInterlockedAnd(SpirvContext context, SpirvBuilder builder, FunctionType functionType, SpirvValue result, SpirvValue value) => CompileInterlockedCall(context, builder, functionType, InterlockedOp.And, result, value);
    ...
    public override SpirvValue CompileInterlockedOr(SpirvContext context, SpirvBuilder builder, FunctionType functionType, SpirvValue result, SpirvValue value) => CompileInterlockedCall(context, builder, functionType, InterlockedOp.Or, result, value);
    ...
    public override SpirvValue CompileInterlockedXor(SpirvContext context, SpirvBuilder builder, FunctionType functionType, SpirvValue result, SpirvValue value) => CompileInterlockedCall(context, builder, functionType, InterlockedOp.Xor, result, value);
    ...
    public override SpirvValue CompileTex1D(SpirvContext context, SpirvBuilder builder, FunctionType functionType, SpirvValue s, SpirvValue x) => throw new NotImplementedException();
