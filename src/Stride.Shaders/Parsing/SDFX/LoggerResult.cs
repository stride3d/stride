...
namespace Stride.Core.Shaders.Utility
{
    ...
    public class LoggerResult
    {
        ...
        public void Error(MessageCode message, TextLocation span)
        {
        ...
        public void Error(MessageCode message, TextLocation span, params object[] parameters)
        {
        ...
        /// <param name="message">The message.</param>
        /// <param name="span">The span.</param>
        public void Info(MessageCode message, TextLocation span)
        {
        ...
        /// <param name="span">The span.</param>
        /// <param name="parameters">The parameters.</param>
        public void Info(MessageCode message, TextLocation span, params object[] parameters)
        {
        ...
        /// <param name="message">The message.</param>
        /// <param name="span">The span.</param>
        public void Warning(MessageCode message, TextLocation span)
        {
        ...
        /// <param name="span">The span.</param>
        /// <param name="parameters">The parameters.</param>
        public void Warning(MessageCode message, TextLocation span, params object[] parameters)
        {
        ...
        /// <param name="message">The message.</param>
        /// <param name="span">The span.</param>
        protected void AddMessage(ReportMessageLevel level, MessageCode message, TextLocation span)
        {
        ...
        /// <param name="span">The span.</param>
        /// <param name="parameters">The parameters.</param>
        protected void AddMessage(ReportMessageLevel level, MessageCode message, TextLocation span, params object[] parameters)
        {
            if (level == ReportMessageLevel.Error) this.HasErrors = true;
