...
public struct TypeDuplicateRemover : INanoPass
{
    ...
    public readonly void Apply(NewSpirvBuffer buffer)
    {
        ...
        ProcessInstructions(buffer, instructionsByOp, Op.OpTypeArray, Op.OpTypeRuntimeArray, true);
        ...
        ProcessInstructions(buffer, instructionsByOp, Op.OpSDSLImportStruct, Op.OpSDSLImportStruct, true);
