...
{
    internal bool ContainsKey<T>(PermutationParameterKey<T> key)
    {
        throw new NotImplementedException();
    }

    internal void Set<T>(PermutationParameterKey<T> key, T? value)
    {
        throw new NotImplementedException();
    }

    internal T Get<T>(PermutationParameterKey<T> key)
    {
        throw new NotImplementedException();
    }
}
...
public class ShaderMixinContext
{
    ...
    public void Mixin(ShaderMixinSource mixinTree, ShaderSource shaderSource)
    {
        ...
        {
            throw new InvalidOperationException($"ShaderSource [{shaderSource.GetType()}] is not supported (Only ShaderMixinSource and ShaderClassSource)");
        }
...
public class PermutationParameterKey<T>
{
    internal PermutationParameterKey<T> ComposeWith(string compositionString)
    {
        throw new NotImplementedException();
    }
}