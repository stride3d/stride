...
void CreateMixin()
{
    ...
    var mixin =
        ...
        .WithFunction("void", "DoNothing", static (ref FunctionBuilder.ParameterBuilder b) => b.With("int", "myInt"))
            .Return()
            .FunctionEnd()
        .WithEntryPoint(ExecutionModel.Vertex, "VSMain")
            ...
            .CallFunction("DoNothing", (ref FunctionCallerParameters p) => p.With(p.Builder.Load("a")))
            .Return()
            .FunctionEnd()
