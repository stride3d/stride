        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0022, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0024, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.BOr(ref scanner, result, out var bOr))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0025, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.XOr(ref scanner, result, out var xor))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0026, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.BAnd(ref scanner, result, out var bAnd))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0027, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.Equality(ref scanner, result, out var eq))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0028, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.Relation(ref scanner, result, out var rel))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0029, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.Shift(ref scanner, result, out var shift))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0030, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.Add(ref scanner, result, out var add))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != '\0' && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0031, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != '\0' && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new(SDSLParsingMessages.SDSL0042, scanner.GetErrorLocation(scanner.Position), scanner.Memory));
            }
            else if (parsed is null && op == '\0')
            {
                if (UnaryParsers.Prefix(ref scanner, result, out var prefix))
